...
##### Output 2:
Your program is expected to process the input file and generate a list of books with *valid* dotted isbn number and fixed isbn number. Invalid inputs must be ignored. This is an example output:
