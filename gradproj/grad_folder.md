...
- Process, Workflow, Project Management
  ...
  - Project charter
  - Project status and progess
  - Sprint planning notes
  - Sprint goals
  - Product backlog
  - Retrospective summaries
  - Velocity and burndown summaries
...
- Version Control, CI/CD, Cloud Infrustructure
  - Repository structure
  - Git workflow (Gitflow, trunk-based)
  - Commit message
  - Pull requests and review checklists
  - CI pipeline configuration (GitHub Actions, GitLab CI, Jenkins)
  - CI metrics summary (build times, test coverage)
  - Deployment pipeline scripts (YAML, Jenkinsfile)
...
- Software Specification Document  
  ...
  - State descriptions or state transition information if applicable  
...
- Technical analysis of existing assets  
  - Analysis report describing structure, dependencies, issues  
  - Dataset analysis describing quality, limitations, preprocessing needs  
...
- Early modelings  
  ...
  - Interaction, workflow, or dataflow diagrams  
